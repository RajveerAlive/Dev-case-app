  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      ...
      <main className="min-h-screen p-4 flex flex-col items-center justify-center">
        ...
        <p className="my-12 md:text-2xl md:w-10/12 text-gray-400 text-center">Upgrad FSD capstone Project</p>
        <p className="mt-12 md:text-2xl md:w-10/12 text-gray-400 text-center">Made by&nbsp;
          <a href="https://github.com/RajveerAlive" target="_blank" className="font-extrabold text-blue-500 cursor-pointer hover:underline">
            @Rajveer singh
          </a>
        </p>
        <p className="mb-12 md:text-2xl md:w-10/12 text-gray-400 text-center">Project GitHub Repo&nbsp;
          <a href="https://github.com/RajveerAlive/Dev-case-app" target="_blank" className="font-extrabold text-blue-500 cursor-pointer hover:underline">
            @dev-case-app
          </a>
        </p>
